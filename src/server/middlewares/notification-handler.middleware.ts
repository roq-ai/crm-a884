...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer.update': {
    roles: ['owner'],
    key: 'customer-update-contact',
    tenantPath: ['organization', 'order', 'customer'],
    userPath: [],
  },
  'customer.delete': {
    roles: ['owner'],
    key: 'customer-delete-contact',
    tenantPath: ['organization', 'order', 'customer'],
    userPath: [],
  },
  'user.update': { roles: ['owner'], key: 'user-update-role', tenantPath: ['organization', 'user'], userPath: [] },
};
