  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the Power of Seamless Interaction with CRM - Revolutionizing Customer Relations Management with Salesforce Automation."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1521790797524-b2497295b8a0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjdXN0b21lciUyMHJlbGF0aW9uc3xlbnwwfHx8fDE2OTQ1OTIyMzJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover the Power of Seamless Interaction with CRM - Revolutionizing Customer Relations Management with Salesforce Automation.`}
            </Text>
            <Box
